...
export interface DelegateUnderlyingToEventObject {
  delegatee: string;
}
export type DelegateUnderlyingToEvent = TypedEvent<
  [string],
  DelegateUnderlyingToEventObject
>;

export type DelegateUnderlyingToEventFilter =
  TypedEventFilter<DelegateUnderlyingToEvent>;
...
export interface DelegationAwareAToken extends BaseContract {
  ...
  filters: {
    ...
    ): DelegateUnderlyingToEventFilter;
    DelegateUnderlyingTo(
      delegatee?: PromiseOrValue<string> | null
    ): DelegateUnderlyingToEventFilter;
